...
ActiveRecord::Schema.define(version: 2021_03_19_192233) do
  ...
  create_table "hmis_2020_affiliations", force: :cascade do |t|
    ...
    t.binary "source_sha256", default: -> { "digest(((((((COALESCE((\"AffiliationID\")::text, ''::text) || COALESCE((\"ProjectID\")::text, ''::text)) || COALESCE((\"ResProjectID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_assessment_questions", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((COALESCE((\"AssessmentQuestionID\")::text, ''::text) || COALESCE((\"AssessmentID\")::text, ''::text)) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((\"AssessmentQuestionGroup\")::text, ''::text)) || COALESCE((\"AssessmentQuestionOrder\")::text, ''::text)) || COALESCE((\"AssessmentQuestion\")::text, ''::text)) || COALESCE((\"AssessmentAnswer\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
    ...
    t.index ["importer_log_id", "DateUpdated"], name: "idx_hmis_2020_assessment_questions_imid_du"
  ...
  create_table "hmis_2020_assessment_results", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((COALESCE((\"AssessmentResultID\")::text, ''::text) || COALESCE((\"AssessmentID\")::text, ''::text)) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((\"AssessmentResultType\")::text, ''::text)) || COALESCE((\"AssessmentResult\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_assessments", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((COALESCE((\"AssessmentID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"AssessmentDate\"))::text, ''::text)) || COALESCE((\"AssessmentLocation\")::text, ''::text)) || COALESCE((\"AssessmentType\")::text, ''::text)) || COALESCE((\"AssessmentLevel\")::text, ''::text)) || COALESCE((\"PrioritizationStatus\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_clients", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest(((((((((((((((((((((((((((((((((((COALESCE((\"PersonalID\")::text, ''::text) || COALESCE((\"FirstName\")::text, ''::text)) || COALESCE((\"MiddleName\")::text, ''::text)) || COALESCE((\"LastName\")::text, ''::text)) || COALESCE((\"NameSuffix\")::text, ''::text)) || COALESCE((\"NameDataQuality\")::text, ''::text)) || COALESCE((\"SSN\")::text, ''::text)) || COALESCE((\"SSNDataQuality\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DOB\"))::text, ''::text)) || COALESCE((\"DOBDataQuality\")::text, ''::text)) || COALESCE((\"AmIndAKNative\")::text, ''::text)) || COALESCE((\"Asian\")::text, ''::text)) || COALESCE((\"BlackAfAmerican\")::text, ''::text)) || COALESCE((\"NativeHIOtherPacific\")::text, ''::text)) || COALESCE((\"White\")::text, ''::text)) || COALESCE((\"RaceNone\")::text, ''::text)) || COALESCE((\"Ethnicity\")::text, ''::text)) || COALESCE((\"Gender\")::text, ''::text)) || COALESCE((\"VeteranStatus\")::text, ''::text)) || COALESCE((\"YearEnteredService\")::text, ''::text)) || COALESCE((\"YearSeparated\")::text, ''::text)) || COALESCE((\"WorldWarII\")::text, ''::text)) || COALESCE((\"KoreanWar\")::text, ''::text)) || COALESCE((\"VietnamWar\")::text, ''::text)) || COALESCE((\"DesertStorm\")::text, ''::text)) || COALESCE((\"AfghanistanOEF\")::text, ''::text)) || COALESCE((\"IraqOIF\")::text, ''::text)) || COALESCE((\"IraqOND\")::text, ''::text)) || COALESCE((\"OtherTheater\")::text, ''::text)) || COALESCE((\"MilitaryBranch\")::text, ''::text)) || COALESCE((\"DischargeStatus\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_current_living_situations", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((((COALESCE((\"CurrentLivingSitID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"InformationDate\"))::text, ''::text)) || COALESCE((\"CurrentLivingSituation\")::text, ''::text)) || COALESCE((\"VerifiedBy\")::text, ''::text)) || COALESCE((\"LeaveSituation14Days\")::text, ''::text)) || COALESCE((\"SubsequentResidence\")::text, ''::text)) || COALESCE((\"ResourcesToObtain\")::text, ''::text)) || COALESCE((\"LeaseOwn60Day\")::text, ''::text)) || COALESCE((\"MovedTwoOrMore\")::text, ''::text)) || COALESCE((\"LocationDetails\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_disabilities", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((((((COALESCE((\"DisabilitiesID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"InformationDate\"))::text, ''::text)) || COALESCE((\"DisabilityType\")::text, ''::text)) || COALESCE((\"DisabilityResponse\")::text, ''::text)) || COALESCE((\"IndefiniteAndImpairs\")::text, ''::text)) || COALESCE((\"TCellCountAvailable\")::text, ''::text)) || COALESCE((\"TCellCount\")::text, ''::text)) || COALESCE((\"TCellSource\")::text, ''::text)) || COALESCE((\"ViralLoadAvailable\")::text, ''::text)) || COALESCE((\"ViralLoad\")::text, ''::text)) || COALESCE((\"ViralLoadSource\")::text, ''::text)) || COALESCE((\"DataCollectionStage\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_employment_educations", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((COALESCE((\"EmploymentEducationID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"InformationDate\"))::text, ''::text)) || COALESCE((\"LastGradeCompleted\")::text, ''::text)) || COALESCE((\"SchoolStatus\")::text, ''::text)) || COALESCE((\"Employed\")::text, ''::text)) || COALESCE((\"EmploymentType\")::text, ''::text)) || COALESCE((\"NotEmployedReason\")::text, ''::text)) || COALESCE((\"DataCollectionStage\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_enrollment_cocs", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((COALESCE((\"EnrollmentCoCID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"HouseholdID\")::text, ''::text)) || COALESCE((\"ProjectID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"InformationDate\"))::text, ''::text)) || COALESCE((\"CoCCode\")::text, ''::text)) || COALESCE((\"DataCollectionStage\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_enrollments", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((COALESCE((\"EnrollmentID\")::text, ''::text) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((\"ProjectID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"EntryDate\"))::text, ''::text)) || COALESCE((\"HouseholdID\")::text, ''::text)) || COALESCE((\"RelationshipToHoH\")::text, ''::text)) || COALESCE((\"LivingSituation\")::text, ''::text)) || COALESCE((\"LengthOfStay\")::text, ''::text)) || COALESCE((\"LOSUnderThreshold\")::text, ''::text)) || COALESCE((\"PreviousStreetESSH\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateToStreetESSH\"))::text, ''::text)) || COALESCE((\"TimesHomelessPastThreeYears\")::text, ''::text)) || COALESCE((\"MonthsHomelessPastThreeYears\")::text, ''::text)) || COALESCE((\"DisablingCondition\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateOfEngagement\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"MoveInDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateOfPATHStatus\"))::text, ''::text)) || COALESCE((\"ClientEnrolledInPATH\")::text, ''::text)) || COALESCE((\"ReasonNotEnrolled\")::text, ''::text)) || COALESCE((\"WorstHousingSituation\")::text, ''::text)) || COALESCE((\"PercentAMI\")::text, ''::text)) || COALESCE((\"LastPermanentStreet\")::text, ''::text)) || COALESCE((\"LastPermanentCity\")::text, ''::text)) || COALESCE((\"LastPermanentState\")::text, ''::text)) || COALESCE((\"LastPermanentZIP\")::text, ''::text)) || COALESCE((\"AddressDataQuality\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateOfBCPStatus\"))::text, ''::text)) || COALESCE((\"EligibleForRHY\")::text, ''::text)) || COALESCE((\"ReasonNoServices\")::text, ''::text)) || COALESCE((\"RunawayYouth\")::text, ''::text)) || COALESCE((\"SexualOrientation\")::text, ''::text)) || COALESCE((\"SexualOrientationOther\")::text, ''::text)) || COALESCE((\"FormerWardChildWelfare\")::text, ''::text)) || COALESCE((\"ChildWelfareYears\")::text, ''::text)) || COALESCE((\"ChildWelfareMonths\")::text, ''::text)) || COALESCE((\"FormerWardJuvenileJustice\")::text, ''::text)) || COALESCE((\"JuvenileJusticeYears\")::text, ''::text)) || COALESCE((\"JuvenileJusticeMonths\")::text, ''::text)) || COALESCE((\"UnemploymentFam\")::text, ''::text)) || COALESCE((\"MentalHealthIssuesFam\")::text, ''::text)) || COALESCE((\"PhysicalDisabilityFam\")::text, ''::text)) || COALESCE((\"AlcoholDrugAbuseFam\")::text, ''::text)) || COALESCE((\"InsufficientIncome\")::text, ''::text)) || COALESCE((\"IncarceratedParent\")::text, ''::text)) || COALESCE((\"ReferralSource\")::text, ''::text)) || COALESCE((\"CountOutreachReferralApproaches\")::text, ''::text)) || COALESCE((\"UrgentReferral\")::text, ''::text)) || COALESCE((\"TimeToHousingLoss\")::text, ''::text)) || COALESCE((\"ZeroIncome\")::text, ''::text)) || COALESCE((\"AnnualPercentAMI\")::text, ''::text)) || COALESCE((\"FinancialChange\")::text, ''::text)) || COALESCE((\"HouseholdChange\")::text, ''::text)) || COALESCE((\"EvictionHistory\")::text, ''::text)) || COALESCE((\"SubsidyAtRisk\")::text, ''::text)) || COALESCE((\"LiteralHomelessHistory\")::text, ''::text)) || COALESCE((\"DisabledHoH\")::text, ''::text)) || COALESCE((\"CriminalRecord\")::text, ''::text)) || COALESCE((\"SexOffender\")::text, ''::text)) || COALESCE((\"DependentUnder6\")::text, ''::text)) || COALESCE((\"SingleParent\")::text, ''::text)) || COALESCE((\"HH5Plus\")::text, ''::text)) || COALESCE((\"IraqAfghanistan\")::text, ''::text)) || COALESCE((\"FemVet\")::text, ''::text)) || COALESCE((\"HPScreeningScore\")::text, ''::text)) || COALESCE((\"ThresholdScore\")::text, ''::text)) || COALESCE((\"VAMCStation\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_events", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((COALESCE((\"EventID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"EventDate\"))::text, ''::text)) || COALESCE((\"Event\")::text, ''::text)) || COALESCE((\"ProbSolDivRRResult\")::text, ''::text)) || COALESCE((\"ReferralCaseManageAfter\")::text, ''::text)) || COALESCE((\"LocationCrisisorPHHousing\")::text, ''::text)) || COALESCE((\"ReferralResult\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"ResultDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
    ...
    t.index ["importer_log_id", "DateUpdated"], name: "idx_hmis_2020_events_imid_du"
  ...
  create_table "hmis_2020_exits", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((((((((((((((((((((((((((((((COALESCE((\"ExitID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"ExitDate\"))::text, ''::text)) || COALESCE((\"Destination\")::text, ''::text)) || COALESCE((\"OtherDestination\")::text, ''::text)) || COALESCE((\"HousingAssessment\")::text, ''::text)) || COALESCE((\"SubsidyInformation\")::text, ''::text)) || COALESCE((\"ProjectCompletionStatus\")::text, ''::text)) || COALESCE((\"EarlyExitReason\")::text, ''::text)) || COALESCE((\"ExchangeForSex\")::text, ''::text)) || COALESCE((\"ExchangeForSexPastThreeMonths\")::text, ''::text)) || COALESCE((\"CountOfExchangeForSex\")::text, ''::text)) || COALESCE((\"AskedOrForcedToExchangeForSex\")::text, ''::text)) || COALESCE((\"AskedOrForcedToExchangeForSexPastThreeMonths\")::text, ''::text)) || COALESCE((\"WorkPlaceViolenceThreats\")::text, ''::text)) || COALESCE((\"WorkplacePromiseDifference\")::text, ''::text)) || COALESCE((\"CoercedToContinueWork\")::text, ''::text)) || COALESCE((\"LaborExploitPastThreeMonths\")::text, ''::text)) || COALESCE((\"CounselingReceived\")::text, ''::text)) || COALESCE((\"IndividualCounseling\")::text, ''::text)) || COALESCE((\"FamilyCounseling\")::text, ''::text)) || COALESCE((\"GroupCounseling\")::text, ''::text)) || COALESCE((\"SessionCountAtExit\")::text, ''::text)) || COALESCE((\"PostExitCounselingPlan\")::text, ''::text)) || COALESCE((\"SessionsInPlan\")::text, ''::text)) || COALESCE((\"DestinationSafeClient\")::text, ''::text)) || COALESCE((\"DestinationSafeWorker\")::text, ''::text)) || COALESCE((\"PosAdultConnections\")::text, ''::text)) || COALESCE((\"PosPeerConnections\")::text, ''::text)) || COALESCE((\"PosCommunityConnections\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"AftercareDate\"))::text, ''::text)) || COALESCE((\"AftercareProvided\")::text, ''::text)) || COALESCE((\"EmailSocialMedia\")::text, ''::text)) || COALESCE((\"Telephone\")::text, ''::text)) || COALESCE((\"InPersonIndividual\")::text, ''::text)) || COALESCE((\"InPersonGroup\")::text, ''::text)) || COALESCE((\"CMExitReason\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_exports", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((((COALESCE((\"SourceType\")::text, ''::text) || COALESCE((\"SourceID\")::text, ''::text)) || COALESCE((\"SourceName\")::text, ''::text)) || COALESCE((\"SourceContactFirst\")::text, ''::text)) || COALESCE((\"SourceContactLast\")::text, ''::text)) || COALESCE((\"SourceContactPhone\")::text, ''::text)) || COALESCE((\"SourceContactExtension\")::text, ''::text)) || COALESCE((\"SourceContactEmail\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"ExportDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"ExportStartDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"ExportEndDate\"))::text, ''::text)) || COALESCE((\"SoftwareName\")::text, ''::text)) || COALESCE((\"SoftwareVersion\")::text, ''::text)) || COALESCE((\"ExportPeriodType\")::text, ''::text)) || COALESCE((\"ExportDirective\")::text, ''::text)) || COALESCE((\"HashStatus\")::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_funders", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest(((((((((((COALESCE((\"FunderID\")::text, ''::text) || COALESCE((\"ProjectID\")::text, ''::text)) || COALESCE((\"Funder\")::text, ''::text)) || COALESCE((\"OtherFunder\")::text, ''::text)) || COALESCE((\"GrantID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"StartDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"EndDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_health_and_dvs", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest(((((((((((((((((COALESCE((\"HealthAndDVID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"InformationDate\"))::text, ''::text)) || COALESCE((\"DomesticViolenceVictim\")::text, ''::text)) || COALESCE((\"WhenOccurred\")::text, ''::text)) || COALESCE((\"CurrentlyFleeing\")::text, ''::text)) || COALESCE((\"GeneralHealthStatus\")::text, ''::text)) || COALESCE((\"DentalHealthStatus\")::text, ''::text)) || COALESCE((\"MentalHealthStatus\")::text, ''::text)) || COALESCE((\"PregnancyStatus\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DueDate\"))::text, ''::text)) || COALESCE((\"DataCollectionStage\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_income_benefits", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((COALESCE((\"IncomeBenefitsID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"InformationDate\"))::text, ''::text)) || COALESCE((\"IncomeFromAnySource\")::text, ''::text)) || COALESCE((\"TotalMonthlyIncome\")::text, ''::text)) || COALESCE((\"Earned\")::text, ''::text)) || COALESCE((\"EarnedAmount\")::text, ''::text)) || COALESCE((\"Unemployment\")::text, ''::text)) || COALESCE((\"UnemploymentAmount\")::text, ''::text)) || COALESCE((\"SSI\")::text, ''::text)) || COALESCE((\"SSIAmount\")::text, ''::text)) || COALESCE((\"SSDI\")::text, ''::text)) || COALESCE((\"SSDIAmount\")::text, ''::text)) || COALESCE((\"VADisabilityService\")::text, ''::text)) || COALESCE((\"VADisabilityServiceAmount\")::text, ''::text)) || COALESCE((\"VADisabilityNonService\")::text, ''::text)) || COALESCE((\"VADisabilityNonServiceAmount\")::text, ''::text)) || COALESCE((\"PrivateDisability\")::text, ''::text)) || COALESCE((\"PrivateDisabilityAmount\")::text, ''::text)) || COALESCE((\"WorkersComp\")::text, ''::text)) || COALESCE((\"WorkersCompAmount\")::text, ''::text)) || COALESCE((\"TANF\")::text, ''::text)) || COALESCE((\"TANFAmount\")::text, ''::text)) || COALESCE((\"GA\")::text, ''::text)) || COALESCE((\"GAAmount\")::text, ''::text)) || COALESCE((\"SocSecRetirement\")::text, ''::text)) || COALESCE((\"SocSecRetirementAmount\")::text, ''::text)) || COALESCE((\"Pension\")::text, ''::text)) || COALESCE((\"PensionAmount\")::text, ''::text)) || COALESCE((\"ChildSupport\")::text, ''::text)) || COALESCE((\"ChildSupportAmount\")::text, ''::text)) || COALESCE((\"Alimony\")::text, ''::text)) || COALESCE((\"AlimonyAmount\")::text, ''::text)) || COALESCE((\"OtherIncomeSource\")::text, ''::text)) || COALESCE((\"OtherIncomeAmount\")::text, ''::text)) || COALESCE((\"OtherIncomeSourceIdentify\")::text, ''::text)) || COALESCE((\"BenefitsFromAnySource\")::text, ''::text)) || COALESCE((\"SNAP\")::text, ''::text)) || COALESCE((\"WIC\")::text, ''::text)) || COALESCE((\"TANFChildCare\")::text, ''::text)) || COALESCE((\"TANFTransportation\")::text, ''::text)) || COALESCE((\"OtherTANF\")::text, ''::text)) || COALESCE((\"OtherBenefitsSource\")::text, ''::text)) || COALESCE((\"OtherBenefitsSourceIdentify\")::text, ''::text)) || COALESCE((\"InsuranceFromAnySource\")::text, ''::text)) || COALESCE((\"Medicaid\")::text, ''::text)) || COALESCE((\"NoMedicaidReason\")::text, ''::text)) || COALESCE((\"Medicare\")::text, ''::text)) || COALESCE((\"NoMedicareReason\")::text, ''::text)) || COALESCE((\"SCHIP\")::text, ''::text)) || COALESCE((\"NoSCHIPReason\")::text, ''::text)) || COALESCE((\"VAMedicalServices\")::text, ''::text)) || COALESCE((\"NoVAMedReason\")::text, ''::text)) || COALESCE((\"EmployerProvided\")::text, ''::text)) || COALESCE((\"NoEmployerProvidedReason\")::text, ''::text)) || COALESCE((\"COBRA\")::text, ''::text)) || COALESCE((\"NoCOBRAReason\")::text, ''::text)) || COALESCE((\"PrivatePay\")::text, ''::text)) || COALESCE((\"NoPrivatePayReason\")::text, ''::text)) || COALESCE((\"StateHealthIns\")::text, ''::text)) || COALESCE((\"NoStateHealthInsReason\")::text, ''::text)) || COALESCE((\"IndianHealthServices\")::text, ''::text)) || COALESCE((\"NoIndianHealthServicesReason\")::text, ''::text)) || COALESCE((\"OtherInsurance\")::text, ''::text)) || COALESCE((\"OtherInsuranceIdentify\")::text, ''::text)) || COALESCE((\"HIVAIDSAssistance\")::text, ''::text)) || COALESCE((\"NoHIVAIDSAssistanceReason\")::text, ''::text)) || COALESCE((\"ADAP\")::text, ''::text)) || COALESCE((\"NoADAPReason\")::text, ''::text)) || COALESCE((\"ConnectionWithSOAR\")::text, ''::text)) || COALESCE((\"DataCollectionStage\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_inventories", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest(((((((((((((((((((((COALESCE((\"InventoryID\")::text, ''::text) || COALESCE((\"ProjectID\")::text, ''::text)) || COALESCE((\"CoCCode\")::text, ''::text)) || COALESCE((\"HouseholdType\")::text, ''::text)) || COALESCE((\"Availability\")::text, ''::text)) || COALESCE((\"UnitInventory\")::text, ''::text)) || COALESCE((\"BedInventory\")::text, ''::text)) || COALESCE((\"CHVetBedInventory\")::text, ''::text)) || COALESCE((\"YouthVetBedInventory\")::text, ''::text)) || COALESCE((\"VetBedInventory\")::text, ''::text)) || COALESCE((\"CHYouthBedInventory\")::text, ''::text)) || COALESCE((\"YouthBedInventory\")::text, ''::text)) || COALESCE((\"CHBedInventory\")::text, ''::text)) || COALESCE((\"OtherBedInventory\")::text, ''::text)) || COALESCE((\"ESBedType\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"InventoryStartDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"InventoryEndDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_organizations", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((COALESCE((\"OrganizationID\")::text, ''::text) || COALESCE((\"OrganizationName\")::text, ''::text)) || COALESCE((\"VictimServicesProvider\")::text, ''::text)) || COALESCE((\"OrganizationCommonName\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_project_cocs", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((COALESCE((\"ProjectCoCID\")::text, ''::text) || COALESCE((\"ProjectID\")::text, ''::text)) || COALESCE((\"CoCCode\")::text, ''::text)) || COALESCE((\"Geocode\")::text, ''::text)) || COALESCE((\"Address1\")::text, ''::text)) || COALESCE((\"Address2\")::text, ''::text)) || COALESCE((\"City\")::text, ''::text)) || COALESCE((\"State\")::text, ''::text)) || COALESCE((\"Zip\")::text, ''::text)) || COALESCE((\"GeographyType\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_projects", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((((((COALESCE((\"ProjectID\")::text, ''::text) || COALESCE((\"OrganizationID\")::text, ''::text)) || COALESCE((\"ProjectName\")::text, ''::text)) || COALESCE((\"ProjectCommonName\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"OperatingStartDate\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"OperatingEndDate\"))::text, ''::text)) || COALESCE((\"ContinuumProject\")::text, ''::text)) || COALESCE((\"ProjectType\")::text, ''::text)) || COALESCE((\"HousingType\")::text, ''::text)) || COALESCE((\"ResidentialAffiliation\")::text, ''::text)) || COALESCE((\"TrackingMethod\")::text, ''::text)) || COALESCE((\"HMISParticipatingProject\")::text, ''::text)) || COALESCE((\"TargetPopulation\")::text, ''::text)) || COALESCE((\"PITCount\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_services", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest((((((((((((((COALESCE((\"ServicesID\")::text, ''::text) || COALESCE((\"EnrollmentID\")::text, ''::text)) || COALESCE((\"PersonalID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateProvided\"))::text, ''::text)) || COALESCE((\"RecordType\")::text, ''::text)) || COALESCE((\"TypeProvided\")::text, ''::text)) || COALESCE((\"OtherTypeProvided\")::text, ''::text)) || COALESCE((\"SubTypeProvided\")::text, ''::text)) || COALESCE((\"FAAmount\")::text, ''::text)) || COALESCE((\"ReferralOutcome\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((\"UserID\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_2020_users", force: :cascade do |t|
    ...
    t.datetime "clean_at"
    t.boolean "should_import", default: true
    t.binary "source_sha256", default: -> { "digest(((((((((COALESCE((\"UserID\")::text, ''::text) || COALESCE((\"UserFirstName\")::text, ''::text)) || COALESCE((\"UserLastName\")::text, ''::text)) || COALESCE((\"UserPhone\")::text, ''::text)) || COALESCE((\"UserExtension\")::text, ''::text)) || COALESCE((\"UserEmail\")::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateCreated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateUpdated\"))::text, ''::text)) || COALESCE((date_part('epoch'::text, \"DateDeleted\"))::text, ''::text)), 'sha256'::text)" }
  ...
  create_table "hmis_csv_2020_affiliations", force: :cascade do |t|
    ...
    t.index ["loader_id"], name: "index_hmis_csv_2020_affiliations_on_loader_id"
  end
  ...
  create_table "hmis_csv_2020_assessment_questions", force: :cascade do |t|
    ...
    t.index ["loader_id"], name: "index_hmis_csv_2020_assessment_questions_on_loader_id"
  end
  ...
  create_table "hmis_csv_2020_assessments", force: :cascade do |t|
    ...
    t.index ["loader_id"], name: "index_hmis_csv_2020_assessments_on_loader_id"
  end
  ...
  create_table "hmis_csv_2020_events", force: :cascade do |t|
    ...
    t.index ["loader_id"], name: "index_hmis_csv_2020_events_on_loader_id"
  end
  ...
  create_table "hmis_csv_2020_exits", force: :cascade do |t|
    ...
    t.index ["loader_id"], name: "index_hmis_csv_2020_exits_on_loader_id"
  end
  ...
  create_table "hud_report_universe_members", force: :cascade do |t|
    ...
    t.index ["report_cell_id", "universe_membership_id", "universe_membership_type"], name: "uniq_hud_report_universe_members", unique: true, where: "((universe_membership_type)::text = 'HudSpmReport::Fy2020::SpmClient'::text)"
  ...
  create_table "report_definitions", id: :serial, force: :cascade do |t|
    ...
    t.index ["url"], name: "index_report_definitions_on_url"
  end
